      ...
      perSystem =
        ...
        }:
        {
          ...
          checks = {
            ...
            nixvim-startup-test =
              pkgs.runCommand "nixvim-startup-test"
                {
            ...
            nixvim-messages-test =
              pkgs.runCommand "nixvim-messages-test"
                {
                  nativeBuildInputs = [ self'.packages.default ];
                }
                ''
            ...
            nixvim-lsp-test =
              pkgs.runCommand "nixvim-lsp-test"
                {
                  nativeBuildInputs = [ self'.packages.default ];
                }
                ''
            ...
            nixvim-keymaps-test =
              pkgs.runCommand "nixvim-keymaps-test"
                {
                  nativeBuildInputs = [ self'.packages.default ];
                }
                ''
